...
| 문서 | 내용 | 갱신 |
|---|---|---|
| [`RESULTS_요약_0920.md`](RESULTS_요약_0920.md) | **실험 결과 한눈에.** Beauty·구인구직·행사 시험의 지표와 수치, 써도 되는 문장 | 9/20 |
| [`BACKEND_설계계획.md`](BACKEND_설계계획.md) | **행사 서비스 백엔드 설계.** 컨테이너, DB, 발급 파이프라인, 배정 엔진, 구축 일정 | 9/20 |
