...
· 🆕 층 수 × 충돌률 실험 → docs/09_층수_충돌률_결과.md
...
### ✅ 코드북 붕괴 — 원인 규명·수정 완료 (자세한 건 docs/09)
...
명령은 docs/10_COLD_구간_데이터셋.md 7절에 그대로 있습니다.
...
│   ├── 09_층수_충돌률_결과.md      ⭐ 층 수 실험 결과
│   └── 10_COLD_구간_데이터셋.md    ⭐ COLD 만든 방법과 한계
├── code/
